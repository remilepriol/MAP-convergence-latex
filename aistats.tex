...
\fdk{I'm worried talking about dimension might be confused with curved EF (less parameters than sufficient statistics). What do you think of
%
\\~\\
%
...
\begin{itemize}
	...
	and its dual local norm $\|\cdot\|_x^*= \sqrt{ \langle [\nabla^2A^*(x)]^{-1}\cdot,\, \cdot \rangle }$,
	\fdk{The second one should be 
	$\sqrt{ \langle [\nabla^2A^*({\color{red} \nabla A(x)})]^{-1}\cdot,\, \cdot \rangle }$?
	}
