...
\begin{important}
{\bf Erratum:} There was an error in our derivations. In the main text, we claimed that the log-partition of a Gaussian was not self-concordant. We will now prove that the opposite is true.
\end{important}
