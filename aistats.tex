...
has led statisticians to study symmetric, better-behaved distances, such as the $L^2$ norm \citep[e.g. \S1.2]{tsybakov2009introduction} , the $L^1$ norm \citep{devroye2001combinatorial} or more recently the Hellinger distance \citep{baraud2017new}.
...
\begin{itemize}
	...
	\item We use a connection between~\eqref{problem} and optimization to highlight areas for progress in the stochastic optimization of barrier objectives (\S\ref{sec:optimization}).
\end{itemize}
