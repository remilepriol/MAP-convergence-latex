...
Setting $\nat_2 = - \nat_1^2$ yields $g''(\nat_2) = 0$ and $g'''(\nat_2) \neq 0$, meaning the second derivative cannot dominate the third derivative for any choice of constant. The log-partition is neither self concordant nor pseudo-self-concordant.
