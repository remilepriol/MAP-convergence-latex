...
Adopting the notation of definition~\ref{def:self-concordance}, let us set $w=(\nat_1 \ 0)^\top$ and $v=(0 \ -1)^\top$.
Then 
\alignn{g(t) := 2A(w+tv) = \frac{a}{t} - \log(t)}
is well defined for $t>0$ and $a=\frac{\nat_1^2}{2} \geq 0$.
...
But let us verify it to be sure. The derivatives of $g$ are
\alignn{
g'(t) &= -\frac{a}{t^2} - \frac{1}{t} \; ,\\
...
The log-partition is neither self concordant nor pseudo-self-concordant.
