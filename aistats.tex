...
Then we prove a useful lemma about the expectation of the natural parameter of the MAP in \S\ref{app:nat-bound}.
Finally we prove upper bounds for the MAP in \S\ref{app:MAP-bound}.
...
Expressions for $n\alpha < 1$ are less elegant. See below \TODO{Damien try this on Matlab?}
