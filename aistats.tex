...
We are aware that \emph{a} solution to this problem would be the maximum likelihood estimate -- which is optimal in some Cramer-Rao sense -- and for which we have asymptotic and large sample results \TODO{cite}. 
...
%kind of redundant problem - question - problem paragraphs, not disentangling stats and optim. To improve
