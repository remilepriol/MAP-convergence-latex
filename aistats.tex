...
To get an upper bound for the MAP, due to the difficulty of finding a closed form for the expectation of the logarithm, we focused on the symmetrized Bregman instead
\aligns{
	\label{eq:log_bound}
...
We deduce that $\Tr(\E[\mV^{-1}]) = \frac{d}{n - d - 1}$.
