...
\end{align}
Now the big question, is : what kind of results do I get with such quantities ? In general, it seems that $\tilde \mu_n$ is a very central and interesting quantity to consider.  We show these decompositions for $\cN(0,\sigma^2)$ in Figure~\ref{fig:variance_decomposition} and  $\cN(\mu, \sigma^2)$ in Figure~\ref{fig:gaussian_decomposition}.
