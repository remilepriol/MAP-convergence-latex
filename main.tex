...
Indeed we study assumption \eqref{eq:hypvariance} for the special case of the variance of a Gaussian in Section \ref{sec:gaussian_variance}.
...
\section{Finding the variance of a Gaussian}
