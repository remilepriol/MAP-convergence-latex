...
Using Jensen inequality, we have the following analog of the bias-variance decomposition:
...
\begin{align}
	...
	- \inv{n+n_0} \E[\langle \hat \natp_n ; \mu^* - T(X_i)  \rangle]\\
	& \leq \bias{\bregmanconj(\mu^*; \mu_n)}
	+ \frac{n_0}{n+n_0} \langle  \bias{\mu_* - \mu_0} ; \variance{\natp_n - \E[\hat \natp_n]} \rangle 
	+ \frac{1}{n+n_0} \smallsum_i \variance{\expect{\langle \hat \natp_n ; T(X_i) - \mu^* \rangle } }
\end{align}
