...
\begin{example}
		We need a formula  for $\E[\MAPt]$ the expectation of the natural MAP estimate
	\begin{align}
	...
	\end{align}
	because $\frac{\mu^* (a + n)}{n +n_0} = \mu_n$. Remark how we almost bounded the deviation between $\E[\MAPt]$ and $\natp_n$.
\end{example}
...
\begin{example}
	\begin{align}
		\bregmanconj(\mu^*; \mu_n)
		 ...
		 & = \frac{n+n_0}{a + n} - 1 - \log \frac{n+n_0}{a +n} \\
		 & = \frac{n_0 - a}{a + n} - \log \frac{n+n_0}{a +n} \\		 
	\end{align}
\end{example}
